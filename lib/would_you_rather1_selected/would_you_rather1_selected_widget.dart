...
class WouldYouRather1SelectedWidget extends StatefulWidget {
  const WouldYouRather1SelectedWidget({Key key}) : super(key: key);

  @override
  _WouldYouRather1SelectedWidgetState createState() =>
      _WouldYouRather1SelectedWidgetState();
}

class _WouldYouRather1SelectedWidgetState
    extends State<WouldYouRather1SelectedWidget> {
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WaitPageWidget(),
                    ),
                    (r) => false,
                  );
                },
