...
class Pictionary2Widget extends StatefulWidget {
  const Pictionary2Widget({Key key}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(15, 80, 15, 10),
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Align(
